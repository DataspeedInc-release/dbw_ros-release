...
* FCA:     ```bash <(curl -s https://bitbucket.org/DataspeedInc/dbw_ros/raw/ros2/dbw1/dbw_fca/scripts/sdk_install.bash)```
* Ford:    ```bash <(curl -s https://bitbucket.org/DataspeedInc/dbw_ros/raw/ros2/dbw1/dbw_ford/scripts/sdk_install.bash)```
* Polaris: ```bash <(curl -s https://bitbucket.org/DataspeedInc/dbw_ros/raw/ros2/dbw1/dbw_polaris/scripts/sdk_install.bash)```
...
* FCA:     ```bash <(curl -s https://bitbucket.org/DataspeedInc/dbw_ros/raw/ros2/dbw1/dbw_fca/scripts/ros_install.bash)```
* Ford:    ```bash <(curl -s https://bitbucket.org/DataspeedInc/dbw_ros/raw/ros2/dbw1/dbw_ford/scripts/ros_install.bash)```
* Polaris: ```bash <(curl -s https://bitbucket.org/DataspeedInc/dbw_ros/raw/ros2/dbw1/dbw_polaris/scripts/ros_install.bash)```
